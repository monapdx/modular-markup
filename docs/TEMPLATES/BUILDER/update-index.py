...
folder_cards = "\n".join(
    f'''    <a class="card purple" href="{d.name}/index.html"><div class="title">{pretty_name(d)}</div><div class="desc">{pretty_name(d)} folder.</div></a>'''
    for d in folders
)
...
content = re.sub(
    r'(<h2 class="folder">HTML</h2>\s*<div class="grid">\n)(.*?)(\n  </div>)',
    rf'\1{html_cards}\3',
    content,
    flags=re.DOTALL
)
...
content = re.sub(
    r'(<h2 class="folder">Folders</h2>\s*<div class="grid">\n)(.*?)(\n  </div>)',
    rf'\1{folder_cards}\3',
    content,
    flags=re.DOTALL
)
